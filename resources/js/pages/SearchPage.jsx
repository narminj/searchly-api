                ...
                <div className="flex gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <ActiveFilterBadges filters={filters} onRemove={setFilter} />
                        </div>

                        {/* Error */}
                        {isError && (
                            <div className="bg-red-50 border border-red-200 text-red-700 rounded-xl p-4 mb-4 text-sm">
                                Axtarış zamanı xəta baş verdi. Elasticsearch serverini yoxlayın.
                            </div>
                        )}
                        ...
                        {!isLoading && products.length === 0 && (
                            <div className="text-center py-20">
                                ...
                                <p className="text-gray-400 text-sm mt-1">Axtarış sözünü və ya filterləri dəyişin</p>
...
// Small badges showing active filters above results
