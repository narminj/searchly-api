...
export function ProductModal({ productId, onClose }) {
    ...
    const color = product ? (CATEGORY_COLORS[product.category] ?? 'bg-gray-100 text-gray-700') : ''
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
                ...
                {isLoading ? (
                    ...
                    <div className="p-6">
                        <span className={`inline-block text-xs font-medium px-2.5 py-1 rounded-full capitalize mb-3 ${color}`}>
                            {product.category}
                        </span>
